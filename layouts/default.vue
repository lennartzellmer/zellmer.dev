  ...
  <div>
    <header>
      <section class="bg-white border-b border-gray-100">
        <header class="max-w-7xl mx-auto sm:px-6 lg:px-8 flex justify-between">
          <nuxt-link
            class="
              flex
              justify-center
          ...
          >
            <svg
              ...
              fill="none"
              viewBox="0 0 100 100"
              class="text-gray-900 w-16 h-auto overflow-visible"
            >
              <path
                id="blob"
                stroke="currentColor"
          ...
          <div class="py-9 flex items-center">
            ...
            >
              <svg
                ...
                stroke-linecap="round"
                stroke-linejoin="round"
                class="feather feather-github w-7 h-auto"
              >
                <path
            ...
            >
              <svg
                ...
                stroke-linecap="round"
                stroke-linejoin="round"
                class="feather feather-twitter w-7 h-auto"
              >
                <path
